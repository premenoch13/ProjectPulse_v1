...
export function ProjectDashboardPage() {
  ...
  const openAdd = () => {
    ...
    setPanel({
      mode: "add",
      data: {
        guid: "", projectCode: "", projectName: "", categoryId: "", clientId: "", billingTypeId: "",
  ...
  const submitPanel = (form, originalResourceGuids = []) => {
    ...
    // Currency must be selected (not blank) — the panel defaults it to INR,
    // but guard against it ever being cleared.

...
export function callAuditEmailFlow(entry) {
  ...
  /* ============================================================
    TIMESHEET FLOW — entity="Timesheet". Note this table has BOTH a
    free-text "Status" column (what the UI reads/writes directly —
    "Pending"/"Approved"/"Rejected") AND a separate ApprovalStatusId
    FK column (optional, not used by TimesheetApprovalPage today).
    No IsActive column on this table — don't add one.
    ============================================================ */

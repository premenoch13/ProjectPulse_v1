...
import { LayoutDashboard, Building2, FolderKanban, DollarSign, ScrollText, ChevronDown, LogOut } from "lucide-react";
            ...
            return (
              <div className="pp-side-group" key={g.label}>
                ...
                {isOpen && g.modules.map((m) => {
                  ...
                  return (
                    <div key={m.key} onClick={() => onSelect(m.key)} className={`pp-side-item${active ? " is-active" : ""}`}>
